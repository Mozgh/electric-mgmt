...
(
  ...
  activePowerA    double   null,
  activePowerB    double   null,
  activePowerC    double   null,
  reactivePowerA  double   null,
  reactivePowerB  double   null,
  reactivePowerC  double   null,
  apparentPowerA  double   null,
  apparentPowerB  double   null,
  apparentPowerC  double   null,
  factorA    double   null,
  factorB    double   null,
  factorC    double   null,
